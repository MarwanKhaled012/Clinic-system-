...
if ($role == '4'){
    ...
    <?php echo "</h3>
        ...
        <input type='number'  name='pPhone' min = '01000000000' max = '01599999999' id = 'phone' placeholder ='";?><?php echo $patientData['phone'] ?><?php echo "'>
        <label> رقم هاتف للطوارئ </label>
        <input type='number' name='pEPhone' min = '01000000000' max = '01599999999' id = 'ePhone' placeholder ='";?><?php echo $patientData['emergencyContact'] ?><?php echo "'>
        <h2> الرقم القومي </h2>
    ...
    <?php echo "</h3>
        ...
        <label> رقم الهاتف </label>
        <input type='number'  name='dPhone' min = '01000000000' max = '01599999999' id = 'phone'  placeholder = '";?><?php echo $doctorData['phone'] ?><?php echo "'>
        <h2> الرقم القومي </h2>
    ...
    <?php echo "</h3>
            ...
            <label> رقم الهاتف </label>
            <input type='number' name='nPhone' min = '01000000000' max = '01599999999' id = 'phone' placeholder = '"; ?><?php echo $nurseData['phone'] ?><?php echo "'>
            <h2> الرقم القومي </h2>
    ...
    <form method='POST' enctype='multipart/form-data' class='form3' onsubmit='validRInputs()' action='handlers/handleEditProfile.php'>
            ...
            <label> رقم الهاتف </label>
            <input type='number' name='rPhone' min = '01000000000' max = '01599999999' id = 'phone' placeholder = '"; ?><?php echo $receptionistData['phone'] ?><?php echo "'>
            <h2> الرقم القومي </h2>
    ...
    <form method='POST' enctype='multipart/form-data' class= 'form100' onsubmit='validAInputs()' action='handlers/handleEditProfile.php'>
        ...
        <label> رقم الهاتف </label>
        <input type='number' id = 'phone' placeholder = '";?><?php echo $adminData['phone'] ?><?php echo "' name='aPhone' min = '01000000000' max = '01599999999'>
        <h2> الرقم القومي </h2>
