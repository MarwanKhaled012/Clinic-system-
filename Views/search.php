    ...
    if ($role == 1 || $role == 2 || $role == 3){
        ...
        if ($resultGetInfo->num_rows > 0) {
            ...
            <div class='card-body flex'>
                ...
                <form method='POST' dir='ltr' onsubmit='validRPInputs()' action='handlers/handlePatientProfile.php'>
                <label> Chest Pain Type </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['chestPainType'] ?><?php echo"' id = 'pCPT' name='pCPT'>
                <br/>
                <label> Blood Pressure </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['bloodPressure'] ?><?php echo"' id = 'pBP' name='pBP'>
                <br/>
                <label> Cholesterol </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['cholesterol'] ?><?php echo"' id = 'pC' name='pC'>
                <br/>
                <label> Max heart rate </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['maxHeartRate'] ?><?php echo"' id = 'pMHR' name='pMHR'>
                <br/>
                <label> Exercise Angina	 </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['exerciseAngina'] ?><?php echo"' id = 'pEA' name='pEA'>
                <br/>
                <label> Plasma Glucose </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['plasmaGlucose'] ?><?php echo"' id = 'pPG' name='pPG'>
                <br/>
                <label> Skin Thickness </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['skinThickness'] ?><?php echo"' id = 'pST' name='pST'>
                <br/>
                <label> Insulin </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['insulin'] ?><?php echo"' id = 'pI' name='pI'>
                <br/>
                <label> BMI </label>
                <input type='number' step = '0.1' placeholder = '"; ?><?php echo $patientData['bmi'] ?><?php echo"' id = 'pBMI' name='pBMI'>
                <br/>
                <label> Diabetes Degree </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['diabetesDegree'] ?><?php echo"' id = 'pDD' name='pDD'>
                <br/>
                <label> Hypertension </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['hypertension'] ?><?php echo"' id = 'pHT' name='pHT'>
                <br/>
                <label> Heart Disease </label>
                <input type='text' placeholder = '"; ?><?php echo $patientData['heartDisease'] ?><?php echo"' id = 'pHD' name='pHD'>
                <br/>
            ...
            if ($role == 3){
                ...
                <hr/>
                <form method='POST' onsubmit = 'validRPPInputs' action = 'handlers/handlePatientProfile.php'>
